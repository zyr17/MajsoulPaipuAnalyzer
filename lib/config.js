...
function checknewestversion(){
    ...
    let pj = repository.replace('https://github.com', 'https://fastly.jsdelivr.net/gh') + '/package.json';
    // let pj = repository.replace('https://github.com', 'https://gitee.com') + '/package.json';  // if jsdelivr fails frequently, can try gitee
